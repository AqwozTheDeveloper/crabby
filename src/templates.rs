...
pub const TEMPLATES: &[Template] = &[
    ...
    Template {
        name: "fastify-ts",
        description: "Fastify framework with TypeScript (faster alternative to Express)",
    },
    ...
    Template {
        name: "vite-vue-ts",
        description: "Vite + Vue 3 + TypeScript + Composition API",
    },
    ...
    Template {
        ...
        description: "Vite + TypeScript (no framework, perfect for learning)",
    },
